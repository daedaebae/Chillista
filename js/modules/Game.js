...
export class Game {
    ...
    serveCustomer() {
        ...
        this.state.stats.dailyEarnings += total;        this.state.stats.cumulativeEarnings += total; // Track total earnings across all days
    ...
    setWeather(type) {
        ...
        if (this.ui.weatherOverlay) {
            if (type === 'rainy') {
                this.ui.weatherOverlay.className = 'weather-overlay weather-rain';                this.ui.weatherOverlay.style.opacity = '1';
        ...
        if (this.ui.weatherIcon) {
            if (type === 'rainy') {
                this.ui.weatherIcon.src = 'assets/weather_rainy.png';                this.ui.weatherIcon.classList.remove('sunny');
